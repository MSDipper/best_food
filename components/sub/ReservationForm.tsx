...
const ReservationForm = () => {
    return (
        ...
        >
                ...
                <input className='max-w-[327px] h-12 xs:text-[12px] sm:text-[15px] placeholder:text-[#fff]  outline-none border border-[#ECB417] bottom-2 bg-transparent text-[#fff] px-6' type="text" placeholder='EMAIL' />               
                <input className='max-w-[327px] h-12 xs:text-[12px] sm:text-[15px] placeholder:text-[#fff]  outline-none border border-[#ECB417] bottom-2 bg-transparent text-[#fff] px-6' type="text" placeholder='TIME' />
