        ...
        >
            <div className='container m-auto'>
                ...
                <motion.div
                    ...
                    whileInView='visible'
                    viewport={{ amount: 0.1 }}
                    className='flex lg:flex-row xs:flex-col gap-x-6 items-center xs:gap-y-6 '>
                    <motion.div 
                    variants={slideInFromBottom(0.1)}
                    className='bg-cat1 relative bg-no-repeat bg-center h-[207px] xs:w-[300px] xxs:w-[366px]'>
                        <div className='bg-[#FFE7A369] xs:w-[300px] xxs:w-[366px] h-[74px] absolute bottom-0'>
                    ...
                    className='bg-cat2 relative bg-no-repeat bg-center h-[207px] xs:w-[300px] xxs:w-[366px]'>
                        <div className='bg-[#FFE7A369] xs:w-[300px] xxs:w-[366px] h-[74px] absolute bottom-0'>
                    ...
                    className='bg-cat3 relative bg-no-repeat bg-center h-[207px] xs:w-[300px] xxs:w-[366px]'>
                        <div className='bg-[#FFE7A369] xs:w-[300px] xxs:w-[366px] h-[74px] absolute bottom-0'>
